          ...
          <div className="content p-16 m-4 w-[60%] box-border bg-[#f7f7f7]">
            <div id="textBlock" className="text-center">
              ...
              <p>
                ...
                backgrounds. Even though we've grown and changed much over the
                years, our mission to promote community, friendship, and culture
                amongst the student body has remained the same. We hold
              ...
              <p>
                ...
                reach out to a staff member! Whether you're an incoming Gaucho,
                a continuing student, or just someone interested in TASA, feel
                free to visit our{" "}
                <Link
