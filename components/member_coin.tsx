...
const MemberCoin = (props: any) => {
    const shouldFlip = props.position !== "Intern";
    return (
        <div className="group h-72 w-72 [perspective:1000px] mx-auto">
            <div className={`relative h-full w-full rounded-full shadow-xl transition-all duration-500 [transform-style:preserve-3d] ${shouldFlip ? 'group-hover:[transform:rotateY(180deg)]' : ''}`}>
