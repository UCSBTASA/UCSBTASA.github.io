        ...
        <div className="p-8 mb-8 flex flex-col md:flex-row">
          <div className="md:w-[60%] md:pr-4">
            ...
            <p className="text-gray-700">
              ...
              Taiwanese dishes like green onion pancake, braised pork over rice
              with tea egg, and popcorn chicken.
            </p>
            <br />
            <p className="text-gray-700">
              Stay tuned for updates on the date and time for TASA Night Market
              2024!
            </p>
          </div>
