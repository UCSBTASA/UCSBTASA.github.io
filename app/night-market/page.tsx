  ...
  return (
    ...
    <div className="px-4 py-8 text-center w-screen h-auto bg-gray-100 flex-col flex items-center ">
      <h2 className="text-3xl font-bold text-gray-900 uppercase">Night Market</h2>
        ...
        <div className = "bg-cover m-10 rounded-2xl	drop-shadow-[0_35px_35px_rgba(0,0,0,0.5)]" style={{ backgroundImage: "url(nm_visuals/img0.jpeg)", width: '90vh', height: '115vh', backgroundRepeat: "no-repeat"}}></div> 
    </div>
    : 
    <div className="px-4 py-8 text-center w-screen h-auto bg-gray-100 flex-col flex items-center ">
      <h2 className="text-3xl font-bold text-gray-900 uppercase">Night Market</h2>
        ...
        {graphicSources.map((source) => <div className = "bg-cover m-10 rounded-2xl	drop-shadow-[0_35px_35px_rgba(0,0,0,0.5)]" style={{ backgroundImage: source, width: vh100 ? vh100*0.25 : '50vh', height: vh100 ? vh100*0.25 : '50vh', backgroundRepeat: "no-repeat"}}></div>)}
        <div className = "bg-cover m-10 rounded-2xl	drop-shadow-[0_35px_35px_rgba(0,0,0,0.5)]" style={{ backgroundImage: "url(nm_visuals/img0.jpeg)", width: vh100 ? vh100*0.25 : '50vh', height: vh100 ? vh100*0.25*9/7 : '50vh', backgroundRepeat: "no-repeat"}}></div> 
    </div>
  );
};
