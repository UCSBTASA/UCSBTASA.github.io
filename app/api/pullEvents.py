...
def pull_events():
    ...
    script_path = os.path.join(current_directory, '..', 'data', 'event_automation', 'script_2.py')
    ...
    if result.returncode == 0:
        ...
        ts_file_path = os.path.join(current_directory, '..', 'eventData.ts')
        ...
        destination_directory = os.path.join(current_directory, '..', 'eventData.ts')
