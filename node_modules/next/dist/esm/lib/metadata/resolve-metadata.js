...
function mergeStaticMetadata(source, target, staticFilesMetadata, metadataContext, titleTemplates) {
    var _source_icons, _source_icons1, _source_twitter, _source_openGraph;
    if (!staticFilesMetadata) return;
    const { icon , apple , openGraph , twitter , manifest  } = staticFilesMetadata;
    // file based metadata is specified and current level metadata icons is not specified
    if (icon && !(source == null ? void 0 : source.icons) && !(source == null ? void 0 : (_source_icons = source.icons) == null ? void 0 : _source_icons.hasOwnProperty("icon")) || apple && !(source == null ? void 0 : (_source_icons1 = source.icons) == null ? void 0 : _source_icons1.hasOwnProperty("apple"))) {
        target.icons = {
            icon: icon || [],
            apple: apple || []
        };
